...
<img class="image_detail lazyload" data-src="${CONFIG.BASE_IMAGE_URL + restaurant.pictureId}" alt="${restaurant.name}">
...
const createItemrestaurant = (restaurant) => `
    <div class="contentlist" id="list">
        ...
        <img class="image lazyload" data-src="${CONFIG.BASE_IMAGE_URL + restaurant.pictureId}" alt="${restaurant.name}">
            <div class="restaurant_info">
                <h2 class="info_title">${restaurant.name}</h2>
                <p class="info_city">${restaurant.city}<p>
                <p class="info_desc">${restaurant.description.slice(0, 330)}...
                </p>
